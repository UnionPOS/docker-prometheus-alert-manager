<!--
  ...
  **
  ...
  -->
# Docker Prometheus Alert Manager



Dockerfile for Prometheus Alert Manager

## Quick Start

Here's how to get started...

1. `git clone https://github.com/UnionPOS/docker-prometheus-alert-manager` to pull down the repository
...
Please use the [issue tracker](https://github.com/UnionPOS/docker-prometheus-alert-manager/issues) to report any bugs or file feature requests.
